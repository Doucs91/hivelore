# Project context — hAIve (v0.29.12)
...
> **Current version**: 0.29.12 — @hiveai/core, cli, mcp, embeddings are versioned together.
...
- **Bridge file** — `CLAUDE.md`, `.cursorrules`, `.github/copilot-instructions.md` auto-generated by `haive init`.
...
cp -r packages/cli/dist/* $NODE_BASE/lib/node_modules/@hiveai/cli/dist/
cp -r packages/mcp/dist/* $NODE_BASE/lib/node_modules/@hiveai/mcp/dist/
# IMPORTANT: also update nested copies (see gotcha memory on nested node_modules)
cp -r packages/core/dist/* $NODE_BASE/lib/node_modules/@hiveai/cli/node_modules/@hiveai/core/dist/
