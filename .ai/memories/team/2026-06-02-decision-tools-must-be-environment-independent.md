...
**Why:** stated by Sady (2026-06-02): "je veux que tous les outils proposés par hAIve soient indépendants de mon environnement car il doit être utilisable par n'importe qui." A tool that breaks when a service is missing kills adoption. Relates to [[2026-05-31-decision-git-sync-protocol-multi-agent]] (agents never npm publish) and the zero-infra positioning in PLAN.md.
